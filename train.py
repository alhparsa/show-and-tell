...
def main(args):
    ...
    CAPTION_FILE_PATH = '../../input/coco-2017-dataset/coco2017/annotations/captions_train2017.json'
    ...
    IMAGES_PATH = '../../input/coco-2017-dataset/coco2017/val2017'
    CAPTION_FILE_PATH = '../../input/coco-2017-dataset/coco2017/annotations/captions_val2017.json'
    ...
    decoder = RNN(embed_size, num_hiddens, len(
        vocab), 1, rec_unit=args.rec_unit)
    ...
    if args.checkpoint_file:
        ...
        )) + list(encoder.linear.parameters()) + list(encoder.batchnorm.parameters())
            ...
            for step, (images, captions, lengths) in enumerate(train_loader, start=initial_step):
                ...
                if step % log_step == 0:
                    ...
                    for val_step, (images, captions, lengths) in enumerate(val_loader):
                        ...
                        batch_loss_val.append(float(val_loss.cpu()))
